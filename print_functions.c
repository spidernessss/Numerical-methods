...
void print_integral_value(void)
{
    ...
    root1 = root(function_1, function_2, 0, 2, 0.001);
    root2 = root(function_2, function_3, 0, 2, 0.001);
    root3 = root(function_1, function_3, -4, -2, 0.001);
    double area;
    // Formula: f1[root3, root1] - f2[root1, root2] - f3[root2, root1]
    area = integral(function_1, root3, root1, 0.001);
    area -= integral(function_2, root1, root2, 0.001);
    area -= integral(function_3, root2, root1, 0.001);
